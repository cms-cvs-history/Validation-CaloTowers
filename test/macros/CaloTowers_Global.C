// Commands executed in a GLOBAL scope, e.g. created hitograms aren't erased...
{
   ...
   TFile f1("CaloTowersValidationALL_206.root");
   TFile f2("CaloTowersValidationALL_210pre6.root");
   ...
   label1[0] = &"CaloTowers_MET.gif";
   label1[1] = &"CaloTowers_SET.gif";
   label1[2] = &"CaloTowers_Ntowers.gif";
   ...
   f1_hist1[0]->GetXaxis()->SetTitle("Calo MET (GeV)");
   f1_hist1[1]->GetXaxis()->SetTitle("Calo SET (GeV)");
   f1_hist1[2]->GetXaxis()->SetTitle("CaloTowers number");
