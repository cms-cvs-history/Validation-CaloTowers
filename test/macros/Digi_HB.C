// Commands executed in a GLOBAL scope, e.g. created hitograms aren't erased...
{
   ...
   label1[0] = &"HcalDigiTask_signal_amplitude_depth1_HB.gif";
   label1[1] = &"HcalDigiTask_ratio_amplitude_vs_simhits_depth1_HB.gif";
   label1[2] = &"HcalDigiTask_bin_5_frac_HB.gif";
   label1[3] = &"HcalDigiTask_bin_6_7_frac_HB.gif";
   label1[4] = &"HcalDigiTask_number_of_amplitudes_above_10fC_HB.gif";

   label2[0] = &"HcalDigiTask_amplitude_vs_simhits_depth1_HB.gif";


   f1->cd("DQMData/HcalDigisV/HcalDigiTask");
   gDirectory->pwd();
   f1_hist1[0] = HcalDigiTask_signal_amplitude_depth1_HB;
   f1_hist1[1] = HcalDigiTask_ratio_amplitude_vs_simhits_depth1_HB;
   f1_hist1[2] = HcalDigiTask_bin_5_frac_HB;
   f1_hist1[3] = HcalDigiTask_bin_6_7_frac_HB;
   f1_hist1[4] = HcalDigiTask_number_of_amplitudes_above_10fC_HB;

   f1_hist2[0] = HcalDigiTask_amplitude_vs_simhits_depth1_HB;

   f2->cd("DQMData/HcalDigisV/HcalDigiTask");
   gDirectory->pwd();
   f2_hist1[0] = HcalDigiTask_signal_amplitude_depth1_HB;
   f2_hist1[1] = HcalDigiTask_ratio_amplitude_vs_simhits_depth1_HB;
   f2_hist1[2] = HcalDigiTask_bin_5_frac_HB;
   f2_hist1[3] = HcalDigiTask_bin_6_7_frac_HB;
   f2_hist1[4] = HcalDigiTask_number_of_amplitudes_above_10fC_HB;

   f2_hist2[0] = HcalDigiTask_amplitude_vs_simhits_depth1_HB;


   f1_hist1[0]->GetXaxis()->SetTitle("HB signal amplitude (fC)");
   f1_hist1[1]->GetXaxis()->SetTitle("HB ratio amplitute (fC) to SimHits (GeV)");
   f1_hist1[2]->GetXaxis()->SetTitle("HB ts 5 signal fraction");
   f1_hist1[3]->GetXaxis()->SetTitle("HB ts 6+7 signal fraction");
   f1_hist1[4]->GetXaxis()->SetTitle("HB N(ampl) > 10 fC");

   f1_hist2[0]->GetXaxis()->SetTitle("HB signal amplitude (fC) vs SimHits (GeV)");
