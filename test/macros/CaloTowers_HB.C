// Commands executed in a GLOBAL scope, e.g. created hitograms aren't erased...
{
   ...
   label1[0] = &"HB_CaloTowers_MET.gif";
   label1[1] = &"HB_CaloTowers_SET.gif";
   label1[2] = &"HB_CaloTowers_Ntowers.gif";
   label1[3] = &"HB_CaloTowers_Energy_in_ECAL.gif"; 
   label1[4] = &"HB_CaloTowers_Energy_in_HCAL.gif"; 
   ...
   f1_hist1[0]->GetXaxis()->SetTitle("HB Calo MET (GeV)");
   f1_hist1[1]->GetXaxis()->SetTitle("HB Calo SET (GeV)");
   f1_hist1[2]->GetXaxis()->SetTitle("HB CaloTowers number");
   f1_hist1[3]->GetXaxis()->SetTitle("HB CaloTowers ECAL energy (GeV)");
   f1_hist1[4]->GetXaxis()->SetTitle("HB CaloTowers HCAL energy (GeV)");

   //   f1_hist1[1]->SetMaximum(400.);
   f1_hist1[0]->GetXaxis()->SetRangeUser(0.,80.);
   f1_hist1[1]->GetXaxis()->SetRangeUser(0.,100.);
   f1_hist1[2]->GetXaxis()->SetRangeUser(0.,50.);
   f1_hist1[3]->GetXaxis()->SetRangeUser(0.,60.);
